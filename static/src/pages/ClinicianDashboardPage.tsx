    ...
    <div className="container mx-auto px-6 lg:px-8 py-12 text-off-white font-sans">
      ...
      <div className="bg-dark-card p-8 rounded-xl shadow-lg border border-border-color mb-12 flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8 animate-fade-in">
        ...
        <button
          ...
          className="ml-auto px-5 py-2.5 border border-electric-blue rounded-md shadow-sm text-sm font-medium text-electric-blue bg-transparent hover:bg-electric-blue hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-dark-card focus:ring-electric-blue transition duration-150 whitespace-nowrap"
        >
          + Add New Visit
        </button>
      </div>

...
import { FaSpinner, FaArrowLeft, FaCalendarAlt, FaUserMd, FaNotesMedical, FaRegCommentDots, FaFilePrescription, FaPills, FaStickyNote, FaUserCircle, FaBell, FaRobot } from 'react-icons/fa';
